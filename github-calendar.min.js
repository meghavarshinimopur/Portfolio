    ...
    return function r(o, a, u) {
            ...
            t.exports = function(d, e, f) {
                ...
                f.getCalendar = f.getCalendar || function(e) {
                    ...
                    return f.proxy(e).then(function(e) {
                        return f.cache && (localStorage.setItem(n.content, e),
                        localStorage.setItem(n.expire_at, Date.now() + f.cache)),
                        e
                    })
                }
                ,
                function l() {
                    return f.getCalendar(e).then(function(e) {
                        var t, r, n = document.createElement("div"), e = (n.innerHTML = e,
                        n.querySelector(".js-yearly-contributions")), o = (g(".position-relative h2", e).remove(),
                        !0), a = !1, u = void 0;
                        try {
                        ...
                        e.querySelector("include-fragment") ? setTimeout(l, 500) : (!0 === f.responsive && (a = (n = e.querySelector("svg.js-calendar-graph-svg")).getAttribute("width"),
                        u = n.getAttribute("height"),
                        n.removeAttribute("height"),
                        n.setAttribute("width", "100%"),
                        n.setAttribute("viewBox", "0 0 " + a + " " + u)),
                        !1 !== f.global_stats && (a = (n = p(g("svg", e).outerHTML)).current_streak ? m(n.current_streak_range[0], y) + " &ndash; " + m(n.current_streak_range[1], y) : n.last_contributed ? "Last contributed in " + m(n.last_contributed, y) + "." : "Rock - Hard Place",
                        u = n.longest_streak ? m(n.longest_streak_range[0], y) + " &ndash; " + m(n.longest_streak_range[1], y) : n.last_contributed ? "Last contributed in " + m(n.last_contributed, y) + "." : "Rock - Hard Place",
                        t = g("<div>", {
                            class: "contrib-column contrib-column-first table-column",
                            html: '<span class="text-muted">Contributions in the last year</span>\n                               <span class="contrib-number">' + n.last_year + ' total</span>\n                               <span class="text-muted">' + m(b.add(b.subtract(new Date, 1, "year"), 1, "day"), h) + " &ndash; " + m(new Date, h) + "</span>"
                        }),
                        u = g("<div>", {
                        ...
                        !0 === f.tooltips && (a = d,
                        (r = document.createElement("div")).classList.add("day-tooltip"),
                        a.appendChild(r),
                        a.querySelectorAll(".js-calendar-graph-svg rect.ContributionCalendar-day").forEach(function(e) {
                            e.addEventListener("mouseenter", function(e) {
                                var t = e.target.getAttribute("data-count")
                                  , n = ("0" === t ? t = "No contributions" : "1" === t ? t = "1 contribution" : t += " contributions",
                                new Date(e.target.getAttribute("data-date")))
                                  , n = v[n.getUTCMonth()] + " " + n.getUTCDate() + ", " + n.getUTCFullYear()
                                  , t = (r.innerHTML = "<strong>" + t + "</strong> on " + n,
                                r.classList.add("is-visible"),
                                e.target.getBoundingClientRect())
                                  , n = t.left + window.pageXOffset - r.offsetWidth / 2 + t.width / 2
                                  , e = t.bottom + window.pageYOffset - r.offsetHeight - 2 * t.height;
                                r.style.top = e + "px",
                                r.style.left = n + "px"
                            }),
        ...
        4: [function(e, t, n) {
            var r = e("iterate-object")
              , o = e("sliced");
            function a(n, e) {
                return "string" == typeof n ? "<" === n.charAt(0) ? (n = document.createElement(n.slice(1, -1)),
                r(e || {}, function(e, t) {
                    switch (t) {
                    case "text":
        ...
        8: [function(e, t, n) {
            ...
            t.exports = function(e) {
                function r() {
                    o.current_streak > o.longest_streak && (o.longest_streak = o.current_streak,
                ...
                return e.split("\n").slice(2).map(function(e) {
                    ...
                    0 === o.current_streak && (o.current_streak_range[0] = n.date),
                    n.count ? (++o.current_streak,
                    o.last_year += n.count,
                    o.last_contributed = n.date,
                    o.current_streak_range[1] = n.date) : (r(),
                    o.current_streak = 0),
                    a.push(n),
                    o.days.push(n))
                }),
            ...
            t.exports = function(e, t) {
                ...
                if (Array.isArray(e))
                    for (; r < e.length && !1 !== t(e[r], r, e); ++r)
                        ;
                else if ("object" === (void 0 === e ? "undefined" : o(e)) && null !== e)
        ...
        11: [function(e, t, n) {
                ...
                value: function(e, t) {
                    ...
                    do {
                        var r = e.match(this.re)
                          , r = r && r[1]
                          , o = r || e.charAt(0)
                    } while (n += r ? r = "function" == typeof (r = this.obj[r]) ? r.apply(this, t) : r : o,
            ...
            function s(e) {
                ...
                this.obj = e || {},
                this.re = new RegExp("^(" + Object.keys(e).map(a).join("|") + ")")
            }
            function i(e, t, n) {
